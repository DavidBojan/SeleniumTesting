...
def test_error_message_text(set_up):
    set_up.find_element(By.ID, selectors_data.username_id).send_keys(expected_data.wrong_username)
    set_up.find_element(By.ID, selectors_data.password_id).send_keys(expected_data.wrong_password)
